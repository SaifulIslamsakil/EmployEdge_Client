...
const Banner = () => {
    return (
        <div className=" bg-gradient-to-r from-blue-200  to-sky-100 lg:pt-20  ">
            <div className="  flex justify-center items-center pt-20 px-5">
                <div className=" space-y-5 text-center">
                    <h1 className=" text-5xl font-bold">Hello, what can we <span className=" text-blue-800">help you find?</span></h1>
                    ...
                    <div className=" md:w-4/5 h-14 bg-white rounded-full mx-auto flex items-center ">
                        <input className=" h-full w-full rounded-full border-none outline-none p-5" placeholder="Search For EmployEdge...." type="search" name="" id="" />
                        <span className=" text-2xl m-3 text-blue-800"><FaSearch /></span>
                    </div>
